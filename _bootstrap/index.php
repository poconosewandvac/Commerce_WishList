...
if (!createObject('modNamespace',array(
    'name' => 'commerce_wishlist',
    'path' => $componentPath.'/core/components/commerce_wishlist/',
    'assets_path' => $componentPath.'/assets/components/commerce_wishlist/',
),'name', false)) {
    echo "Error creating namespace commerce_wishlist.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_wishlist.core_path',
    'value' => $componentPath.'/core/components/commerce_wishlist/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_wishlist',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_wishlist.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_wishlist.assets_path',
    'value' => $componentPath.'/assets/components/commerce_wishlist/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_wishlist',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_wishlist.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_wishlist/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_wishlist.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_wishlist',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_wishlist.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_wishlist.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_wishlist/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_wishlist/src/Modules/';
